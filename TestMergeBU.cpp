...
#include <time.h>
#include <math.h>
#include "Sort/MergeSortBU/MergeSortBU.h"
...
int main ()
{
    ...
    MergeSortBU Srt(array, aux, &nb_data);
    ...
    std::cout<<std::endl<<"MergeSortBU ascendant"<<std::endl;
    Srt.InitSort(true);
    show_array(array, nb_data);

    std::cout<<std::endl<<"MergeSortBU descendant"<<std::endl;
    Srt.InitSort(false);
    show_array(array, nb_data);

...
#include "Sort/MergeSort/InsertionSort.h" 
...
int main ()
{
    ...
    MergeSort Srt(array, aux, &nb_data, &CUTOFF);
    ...
    std::cout<<std::endl<<"MergeSort ascendant"<<std::endl;
    Srt.InitSort(true);
    show_array(array, nb_data);

    std::cout<<std::endl<<"MergeSort descendant"<<std::endl;
    Srt.InitSort(false);
    show_array(array, nb_data);
